...
export const DEFAULT_DATA: AppData = {
  ...
  settings: {
    ...
    snowPlow4inHrs: 4,
    snowPlow4inSF: 66000,
    snowShovel4inHrs: 4.5,
    snowShovel4inSF: 7000,
    snowPlow1_5inHrs: 2,
    snowPlow1_5inSF: 66000,
    snowShovel1_5inHrs: 1.5,
    snowShovel1_5inSF: 7000,
    snowPlowDustingHrs: 1,
    snowPlowDustingSF: 66000,
    snowShovelDustingHrs: 1,
    snowShovelDustingSF: 7000,
  ...
  clients: [
    {
      ...
      properties: [{ id: 'clp1', name: '', street1: 'LaQuinta Inn & Suites', street2: '', city: 'Minnetonka', state: 'MN', zip: '', taxRateId: undefined, isBillingAddress: true, contactIds: ['clc1'], notes: 'Year-round contract. Purchased through HMS PO#1 package deal.' }],
    ...
    },
    {
      ...
      type: 'commercial' as const,
      contacts: [],
      properties: [{ id: 'clp2', name: '', street1: '', street2: '', city: 'Minneapolis', state: 'MN', zip: '', taxRateId: undefined, isBillingAddress: true, contactIds: [], notes: 'Spring/Summer/Fall. Winter per-trip billing.' }],
      leadSource: '' as const,
      tags: [],
